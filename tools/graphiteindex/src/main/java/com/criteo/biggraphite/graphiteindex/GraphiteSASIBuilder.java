...
public class GraphiteSASIBuilder extends SecondaryIndexBuilder {
    ...
    protected void buildIndex(SSTableReader sstable)
    {
        try (
            ...
            while (keys.hasNext()) {
                ...
                // TODO: indexWriter.startPartition(key, keyPosition);
                ...
                try {
                    ...
                    try (
                        ...
                        while (partition.hasNext()) {
                            // TODO: indexWriter.nextUnfilteredCluster(partition.next());
                            partition.next();
                        }
                    }
                } catch (IOException e) {
            ...
            // TODO: completeSSTable(indexwriter, sstable, indexes.values());
        }
    }
}
